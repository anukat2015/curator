...
def sample_company_data_array
  [
    ...
    },
    {
      ...
      :ebit => -109344000.0,
      :ebit_date => "2014-12-31",
      :market_cap => 475510177.62,
      :market_cap_date => "2015-03-02",
      :cash_and_equivalents => 57105000.0,
      :cash_and_equivalents_date => "2014-12-31",
      :total_debt => 935035000.0,
      :total_debt_date => "2014-12-31",
      :enterprise_value => 1353440177.62,
      :earnings_yield => -0.08079,
      :total_assets =>2067836000.0,
      :total_assets_date => "2014-12-31",
      :current_assets => 500548000.0,
      :current_assets_date => "2014-12-31",
      :working_capital => 121904000.0,
      :working_capital_date => "2014-12-31",
      :fixed_assets => 1567288000.0,
      :return_on_capital => -0.064732
    },
    {
      :symbol => "TTPH",
      :ebit => -20379000.0,
      :ebit_date => "2014-12-31",
      :market_cap => 1148922761.62,
      :market_cap_date => "2015-03-06",
      :cash_and_equivalents => 121241000.0,
      :cash_and_equivalents_date => "2014-12-31",
      :total_debt => 4560000.0,
      :total_debt_date => "2014-12-31",
      :enterprise_value => 1032241761.6199999,
      :earnings_yield => -0.019742,
      :total_assets => 127204000.0,
      :total_assets_date => "2014-12-31",
      :current_assets => 126597000.0,
      :current_assets_date => "2014-12-31",
      :working_capital => 109321000.0,
      :working_capital_date => "2014-12-31",
      :fixed_assets => 607000.0,
      :return_on_capital => -0.185385
    }
  ]
end
...
def return_on_capital_data_1
  {
                :symbol => "AAPL",
                  :ebit => 18564000000.0,
             :ebit_date => "2015-03-28",
          :total_assets => 261194000000.0,
     :total_assets_date => "2015-03-28",
        :current_assets => 67891000000.0,
   :current_assets_date => "2015-03-28",
       :working_capital => 9162000000.0,
  :working_capital_date => "2015-03-28",
          :fixed_assets => 193303000000.0,
     :return_on_capital => 0.09169
  }
end
