def sample_company_data_1
  {
    :symbol => "AAPL",
    :ebit => 18564000000.0,
    :ebit_date => "2015-03-28",
    :market_cap => 752160076800.0,
    :market_cap_date => "2015-04-28",
    ...
    :total_debt => 43871000000.0,
    :total_debt_date => "2015-03-28",
    :cash_and_equivalents => 14489000000.0,
    :cash_and_equivalents_date => "2015-03-28",
    :enterprise_value => 781542076800.0,
    :earnings_yield => 0.023753,
  ...
  [
    {
      :symbol => "TESS",
      :ebit => 2859500.0,
      :ebit_date => "2015-06-28",
      :market_cap => 188447486.54,
      :market_cap_date => "2015-08-06",
      :cash_and_equivalents => 6377300.0,
      :cash_and_equivalents_date => "2015-06-28",
      :total_debt => 2145500.0,
      :total_debt_date => "2015-06-28",
      :enterprise_value => 184215686.54,
      :earnings_yield => 0.015523,
      :total_assets => 195308700.0,
      :total_assets_date => "2015-06-28",
      :current_assets => 160117500.0,
      :current_assets_date => "2015-06-28",
      :working_capital => 86045100.0,
      :working_capital_date => "2015-06-28",
      :fixed_assets => 35191200.0,
      :return_on_capital => 0.023586
    },
    {
      :symbol => "TSRA",
      :ebit => 40095000.0,
    ...
    },
    {
      ...
      :ebit => 40675000.0,
      :ebit_date => "2015-06-28",
      :market_cap => 1603940713.47,
      :market_cap_date => "2015-07-31",
      :cash_and_equivalents => 175183000.0,
      :cash_and_equivalents_date => "2015-06-28",
      :total_debt => 236221000.0,
      :total_debt_date => "2015-06-28",
      :enterprise_value => 1664978713.47,
      :earnings_yield => 0.02443,
      :total_assets => 1703522000.0,
      :total_assets_date => "2015-06-28",
      :current_assets => 870467000.0,
      :current_assets_date => "2015-06-28",
      :working_capital => 415570000.0,
      :working_capital_date => "2015-06-28",
      :fixed_assets => 833055000.0,
      :return_on_capital => 0.032576
    },
    {
      :symbol => "TTI",
      :ebit => 30006000.0,
      :ebit_date => "2015-06-30",
      :market_cap => 550921176.57,
      :market_cap_date => "2015-08-10",
      :cash_and_equivalents => 50638000.0,
      :cash_and_equivalents_date => "2015-06-30",
      :total_debt => 936112000.0,
      :total_debt_date => "2015-06-30",
      :enterprise_value => 1436395176.5700002,
      :earnings_yield => 0.02089,
      :total_assets => 2003645000.0,
      :total_assets_date => "2015-06-30",
      :current_assets => 451473000.0,
      :current_assets_date => "2015-06-30",
      :working_capital => 124362000.0,
      :working_capital_date => "2015-06-30",
      :fixed_assets => 1552172000.0,
      :return_on_capital => 0.017898
    },
    {
      :symbol => "TTPH",
      :ebit => -18044000.0,
